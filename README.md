# Курсовой проект выполнен Садыковым Виктором Наильевичем 
# студентом 25 потока курса Разработчик Phyton  онлайн школы SkyPro


# Курсовой проект по курсу «Основы backend-разработки»

[ссылка на задание курсовой](https://skyengpublic.notion.site/backend-d7ae5783bfe34551ae526a9f4ec18b57)
